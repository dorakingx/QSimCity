...
export const TOUR_CHAPTERS: readonly TourChapter[] = [
  {
    ...
    why: 'Everything downstream is determined by this input. Reproducibility starts with hashing exactly what arrived at the port.',
  },
  {
    id: 'logical-qubits',
    ...
    why: 'Keeping logical and physical qubits distinct is the single most important habit for reading compiler output.',
  },
  {
    id: 'normalization',
    ...
    why: 'Compilers reason over a small vocabulary. Normalization is why a 3-qubit gate becomes a longer but equivalent story in 1- and 2-qubit words.',
  },
  {
    id: 'initial-layout',
    ...
    why: 'A poor initial layout forces extra routing. You can test this causally: switch the Layout Desk to trivial and rerun a long-range circuit.',
  },
  {
    id: 'topology',
    ...
    why: 'Topology is the constraint that makes compilation interesting: algorithms assume any-to-any, hardware disagrees.',
  },
  {
    id: 'routing',
    title: 'Routing',
    ...
    why: 'Every hop on this path becomes a SWAP. Distance on the coupling map is the currency routing spends.',
  },
  {
    id: 'swap',
    ...
    why: 'SWAPs are pure overhead: they add error exposure without advancing the algorithm. Compare SWAP counts across devices in Compare Mode.',
  },
  {
    id: 'translation',
    ...
    why: 'What you write is not what runs. Reading compiled output requires knowing the native basis the machine speaks.',
  },
  {
    id: 'optimization',
    ...
    why: 'Shorter circuits finish sooner and meet less noise. Toggle the Mill Lever off and rerun to see the cost of skipping this stage.',
  },
  {
    id: 'scheduling',
    title: 'Scheduling',
    ...
    why: 'Idle qubits still decohere. Understanding the schedule explains why depth, not gate count, is the enemy.',
  },
  {
    id: 'execution',
    title: 'QPU Execution',
    ...
    why: 'This is the honest version of the “quantum computer working” picture: a simulation you may inspect completely, clearly labeled as such.',
  },
  {
    id: 'noise',
    title: 'Noise',
    ...
    why: 'Noise is why quantum computing is hard. Turn the dials at the weather station and watch distributions smear in Compare Mode.',
  },
  {
    id: 'measurement',
    title: 'Measurement',
    ...
    why: 'Quantum programs do not output states; they output samples. Everything you learn from a quantum computer arrives through this dock.',
  },
  {
    id: 'statistics',
    ...
    why: 'Run the Shot Drought scenario: with too few shots, even a perfect computer looks noisy. Statistics is part of the machine.',
  },
  {
    id: 'feedback',
    ...
    why: 'This loop — measure, decide, act — is what makes quantum computers computers rather than physics demonstrations.',
  },
  {
    id: 'comparison',
    ...
    why: 'Comparison is how every claim in QSimCity is kept honest — and how you will reason about real quantum hardware. This concludes the tour; the whole city is now yours to explore.',
  },
];
