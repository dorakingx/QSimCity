...
open-source educational and research project** under the Apache License 2.0 —
not affiliated with Electronic Arts, Maxis, IBM, or any quantum-hardware
vendor. Documentation must name the license the `LICENSE` file actually grants
(see docs/adr/adr-0004-apache-2-0-license.md); `pnpm goal:check` enforces
