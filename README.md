...
Measured on source tree `2d85dcc67da479c1`. Every row is bound to an
...
- **Bound to** source tree `2d85dcc67da479c1`; `pnpm goal:check` rejects the recording once the tree moves.
